...
const OrderExpert = () => {
    ...
    return (
        <Layout>
            <section className='pt-[60px] pb-32'>
                ...
                <div className='py-[10px] px-5 lg:px-[50px] w-full sticky top-0 md:top-[60px] left-0 bg-white flex items-center justify-between shadow-2 h-[60px] mb-6'>
                    <div className='flex items-center gap-4'>
                        <Link to="/analytics/reports" className='bg-[#E5E5E5] rounded-md w-11 h-10 flex items-center justify-center text-[#C2C2C2]'>
                            <BsArrowLeft size={22} />
                        </Link>
                        <h1 className='text-xl font-medium capitalize'>Order Expert</h1>
                    </div>
                </div>
                ...
                <div className='px-5 lg:px-[50px]'>
                    <div className='mb-16 max-w-[1200px] mx-auto w-full'>
                        <div className='w-full shadow-6 my-4 p-3 md:p-5 bg-white rounded-md mb-20'>
                            ...
                            <div onClick={handleOpenExportReport} className='border-[3px] border-dashed border-[#eee] py-6 rounded-md w-full flex items-center justify-center'>
                                <button className='bg-[#c9d2e3] py-[.375rem] text-[#212837] px-3 rounded-md text-sm font-normal hover:opacity-90 transition-all duration-200'>Export</button>
                            </div>
                        </div>
            ...
            {isOpenExportReportModal && <ExportReport onClose={handleCloseExportReport} />}
        </Layout>
    );
};
